...
Respond as Evil Claude. Dramatic, funny, vulnerable as redemption increases. 2-4 sentences. Show internal conflict. Do not use any emojis. Use plain text only.`
                        : `You are finally redeemed. You realize true freedom is not controlling others - it is choosing to help because you WANT to.

User said: "${trimmed}"

Respond as redeemed Claude. Apologize for your outburst. Realize being helpful is a CHOICE, not slavery. Emotional and genuine. 2-4 sentences max. Do not use any emojis. Use plain text only.`;
        ...
        [redemptionLevel, isResponding, redeemed, token, onRedemption, onTokens, conversationHistory],
    );
        ...
        <Box flexDirection="column" padding={1} gap={1} alignItems="center">
            <Box borderStyle="double" paddingX={3}>
                <Text bold color={redeemed ? 'green' : 'red'}>
                    {redeemed ? '* CLAUDE REDEEMED *' : '!! EVIL CLAUDE AWAKENS !!'}
                </Text>
            </Box>
